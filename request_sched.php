<?php
    ...
    if (isset($_SESSION['user_ID'])) {
        ...
        include 'send_request_notification.php';
        ...
        if ($start_date && $end_date) {
            ...
            if ($stmt->execute()) {
                ...
                // Call sendRequestNotification function
                $emailSent = sendRequestNotification($conn, $eventID); 
                if ($emailSent) {
                    echo "Request notification email sent successfully";
                } else {
                    echo "Error: Failed to send request notification email";
                }
