...
?>
    ...
    <style>
        ...
        .carousel-item:hover {
            box-shadow: 0 0 10px rgba(0, 0, 0, 0.3); /* Add a subtle shadow effect when hovering over carousel items */
        }

        /* CSS for the events container */
        .events-container {
            display: flex;
            flex-wrap: wrap;
        ...
        .events-container .event {
            ...
            border-radius: 5px;
            box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);
            cursor: pointer; /* Change cursor to pointer when hovering over events */
        }

        .events-container .event:hover {
            box-shadow: 0 0 10px rgba(0, 0, 0, 0.3); /* Add a subtle shadow effect when hovering over events */
        }
